                        ...
                        <form method="POST" action="{{ route('roles.store') }}" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="name" class="form-control @error('name') is-invalid @enderror"
                                    value="{{ old('name') }}" type="text" autocomplete="on" id="name" autofocus required />
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input name="description" class="form-control @error('description') is-invalid @enderror"
                                    value="{{ old('description') }}" type="text" autocomplete="on" id="description"autofocus required />
                                @error('description')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-block w-100 mt-3" type="submit name="submit">{{ __('Add New role') }}</button>
                            </div>
                        </form>
